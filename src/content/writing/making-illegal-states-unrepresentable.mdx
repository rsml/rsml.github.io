...
Here's a quick survey of some of the advanced patterns you can use in TypeScript to make your code safer. Each section header links out to a deeper, mostly third-party write-up if you want more detail on a pattern.
